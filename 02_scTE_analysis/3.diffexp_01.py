...
sc.tl.rank_genes_groups(adata, 'leiden_r0.25', method='wilcoxon', n_genes=2000)
adata.write('./de.h5ad')
...
topall.to_csv('top100_before.csv')
...
print(joined)
sc.pl.dotplot(adata, joined, groupby='leiden_r0.25', dot_max=0.7, dendrogram=True, standard_scale='var', show=False, save='de-tes.pdf')
sc.pl.matrixplot(adata, joined, groupby='leiden_r0.25', dendrogram=True, standard_scale='var', show=False, save='de-tes.pdf')
